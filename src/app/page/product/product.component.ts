...
export class ProductComponent implements OnInit {
  ...
  totalElementos: number | undefined = 0;
  pagina: number | undefined  = 0;
  tamanho = 5;
  ...
  listarProductes(pagina: number | undefined, tamanho: number) {// definir a primeira página e o tamanho inicial
